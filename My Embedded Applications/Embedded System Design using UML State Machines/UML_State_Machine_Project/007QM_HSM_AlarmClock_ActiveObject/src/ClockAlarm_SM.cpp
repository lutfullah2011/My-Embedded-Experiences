/*$file${HSMs::../src::ClockAlarm_SM.cpp} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*
* Model: ClockAlarm.qm
...
/*$define${HSMs::AO_ClockAlarm} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/

/*${HSMs::AO_ClockAlarm} ...................................................*/
QActive *const AO_ClockAlarm = &Clock_Alarm_obj.super; //adress of the main(Clock_Alarm) class object
/*$enddef${HSMs::AO_ClockAlarm} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
/*$define${HSMs::Clock_Alarm_ctor} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
...
/*$define${HSMs::Clock_Alarm} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
...
static QState Clock_Alarm_Clock(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case TICK_SIG: {
            ...
            Q_PAR(&me->alarm) = Clock_Alarm_get_curr_time()/10;//We do not need to milisecond infos.
...
ISR(TIMER1_COMPA_vect){
    ...
    if(++count == 100U){
        count=0;
        Clock_Alarm_update_curr_time(); //Update the current time every 100 ms
        QACTIVE_POST_ISR(AO_ClockAlarm, TICK_SIG, 0U);//Sending TICK event
    }
