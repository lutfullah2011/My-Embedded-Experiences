...
//In this project, State Handler Approach used with the help of Function Pointers.
...
//Function Pointers Declaration MACROs
...
void protimer_init(protimer_t *obj){
    ...
    obj->pro_time = 0;
    (*obj->active_state)(obj,&ee); //Jump to IDLE handler Function with Function Pointer
    /*STATE MACHINE Implementation with State Handler Technique*/
