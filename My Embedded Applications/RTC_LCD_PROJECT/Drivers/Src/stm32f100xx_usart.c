...
/******************************************************************************/
/*                  ##### USART Peripheral Module Driver #####	              */
/******************************************************************************/
...
/*
 * De-Initializes the USARTx with the pUSARTHandle.
 * I used only USART1, So it is simple.
 */
void USART_DeInit(USART_RegDef_t *pUSARTx)
{
	USART1_REG_RESET();  /* USART1 clock reset */
}
...
/*
 * USART Peripheral CLEAR Flag according to flag name.
 */
...
/*
 * Data Transmit with non-blocking(Interrupt) Method
...
/*************************Check for TC flag ********************************************/
	...
	if(temp1 && temp2 )
	{
		//this interrupt is because of TC (Transfer complete)
...
//We dont discuss multibuffer communication in this course. please refer to the Reference Manual
