...
uint32_t flashAddress = 0x0801FC00 ; //reference manuel syf 42, page 127
uint32_t flashData = 0x56; //rastgele data
uint32_t dataRead = 0;
...
//extern void FLASH_PageErase(uint32_t flashAddress);
